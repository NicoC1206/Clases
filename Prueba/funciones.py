...
def agregar_libro(codigo, titulo, autor, genero, anio, editorial, es_novedad, 
...
def agregar_libro(codigo, titulo, autor, genero, anio, editorial, es_novedad, 
    ...
    libros[codigo] = [titulo, autor, genero, ano_int, editorial, es_novedad]
