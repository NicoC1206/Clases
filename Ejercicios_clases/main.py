...
if __name__ == "__main__": #es el interruptor del programa, si se ejecuta el programa directamente, se ejecutará el menu, si se importa como módulo, no se ejecutará el menu
    menu()